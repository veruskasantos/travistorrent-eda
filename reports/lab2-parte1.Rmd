...
O gráfico acima mostra uma relação crescente entre a quantidade de testes por linha de código e a densidade de testes com a proporção de builds de sucesso, para ambas a linguagem. Entretanto, é difícil comparar qual das linguagens apresenta melhores resultados.
