...
Existem 244 projetos com ao menos 10 contribuidores. Eles são exibidos abaixo (pontos) com a sua respectiva proporção de buid de sucesso (eixo y). A maioria dos projetos, tanto em Java com em Ruby, possuem mais de 50% de build de sucesso, pois, há poucos pontos abaixo de 0.50 no gráfico abaixo.
