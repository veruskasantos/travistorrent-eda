...
As análises acima nos possibilitaram ver os dados garficamente e identificar possíveis padrões entre as variáveis. Quando há relação entre as variáveis é fácil identificar tal padrão, como é o exemplo da QP1, porém, quando as variáveis não são relacionadas é mais difícil inferir alguma conclusão.
